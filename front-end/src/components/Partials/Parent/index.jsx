...
import { Card, CardHeader, CardBody, CardFooter, CardTitle, CardSubtitle, Col, CardText} from 'reactstrap';
...
const KEY_SHORT_INFO = AppKeys['DESCRIPTION'];
...
class PartialParent extends React.Component {
  ...
  render () {
    ...
    return (
      <Col className = "PartialParent_singleParent" key={ key } style={{ marginTop: 20, marginBottom: 20}}>
      <Card  color = "plum" outline style={{}}>
        <CardHeader>
