    ...
    const makeCommentElement = (comment, id) => {
      ...
      return (
        <div key = {key_comment}>
          ...
          <div style = {{margin:'2px 0px 10px 20px', border:'1px solid black',borderRadius: '5px'}}>
            <button className='Button_navigation' onClick={ ()=>actionSaveReply(id)}>Reply Above Comment</button>
            <textarea style = {{width:'100%'}} onChange={setReplyValue(id)}></textarea>
          </div>
        </div>
      );
    }
        ...
        <div className="ViewJobsBabysitter">
          ...
          <div className="ViewJobsBabysitter_all">
            ...
            <div style = {{margin:'10px 2px 10px 2px', border:'1px solid black',borderRadius: '5px'}}>
              <button className='Button_navigation' onClick={ actionSaveComment }>Leave New Comment</button>
              <button className='Button_navigation' 
                style = {{margin:'0px 10px 0px 10px', color : isDisabled ? 'gray':'blue'}}
                onClick={ actionVote }
                disabled = {isDisabled}
              >
                Vote
              ...
              <textarea style = {{width:'100%'}} onChange={ setValue('comment_description') }></textarea>
            </div>
