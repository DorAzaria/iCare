...
import {Button, FormText, Row, Col, Container,Label, Form, FormGroup, Input } from 'reactstrap';
...
class ViewParentRegister extends React.Component {
    ...
    render () {
        ...
        const actionSubmit = () => {
            ...
            let { email, firstName, lastName, password, repassword, type, phoneNumber, houseNumber, age, gender, city, streetName } = state;
            ...
            if (repassword !== password) {
                this.setState ( {errorMsg:'Re-Password should be matched with password'});
                return;
            }
            ...
            if ( age_num < 18) {
                this.setState ( {errorMsg:'Age should be older than 18'});
                return;                
            }
                ...
                <Row className='justify-content-md-center'>
                    <div className="ViewRegisterMainGate parent-register-form">
                        ...
                        <Form style={{padding: '15px', width: '80%'}}>
                            ...
                            <FormGroup>
                                <Input type="email" name="email" id="Email" onChange={(e) => {handleChange(e)} } placeholder="Email" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="password" name="password" id="Password" onChange={(e) => {handleChange(e)} } placeholder="Password" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="password" name="repassword" id="RePassword" onChange={(e) => {handleChange(e)} } placeholder="Re-Password" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="text" name="age" id="Age" onChange={(e) => {handleChange(e)} } placeholder="Age" />
                                <span style = {{color:'red'}}> { ageError }</span>
                                <FormText>
                                    <span className='text-muted' style={{fontSize: '10px'}}>Minimum Age: 18 years old</span>
                                </FormText>
                            </FormGroup>
                            <Row className='mb-3 pt-3'>
                                <div className="ViewRegisterMainGate_title">
                            ...
                            <FormGroup>
                                <Input type="text" name="firstName" id="firstName" onChange={(e) => {handleChange(e)} } placeholder="First Name" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="text" name="lastName" id="lastName" onChange={(e) => {handleChange(e)} } placeholder="Last Name" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="text" name="phoneNumber" id="phoneNumber" onChange={(e) => {handleChange(e)} } placeholder="Phone Number" />
                            </FormGroup>
                            <Row className='mb-3' style={{backgroundColor: '#e8e3e3', marginLeft: '1px', marginRight: '1px', 'borderRadius': '5px', padding: '5px'}}>
                                <Col sm={4}>
                                    <FormText>
                                        <span className='text-muted' style={{fontSize: '14px'}}>Gender</span>
                                    </FormText>
                                </Col>
                                <Col sm={4}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="radio" name="gender" value={0} onChange={(e) => {handleChange(e)} } />{' '}
                                            <span className='text-dark' style={{fontSize: '14px'}}>Male</span>
                                        </Label>
                                    </FormGroup>
                                </Col>
                                <Col sm={4}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="radio" name="gender" value={1} onChange={(e) => {handleChange(e)} } />{' '}
                                            <span className='text-dark' style={{fontSize: '14px'}}>Female</span>
                                        </Label>
                                    </FormGroup>
                                </Col>
                            </Row>
                            ...
                            <FormGroup>
                                <Input type="text" name="streetName" id="streetName" onChange={(e) => {handleChange(e)} } placeholder="Street Name" />
                            </FormGroup>
                            <FormGroup>
                                <Input type="text" name="houseNumber" id="houseNumber" onChange={(e) => {handleChange(e)} } placeholder="House Number" />
                            </FormGroup>
                            <Row className='mt-4'>
...
export default ViewParentRegister;