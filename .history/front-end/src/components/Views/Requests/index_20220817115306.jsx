      ...
      <div className="add-job-div">
        ...
        <Form style={{marginTop: 20}}>
          ...
          <Row lg = "2" md = "2" sm = "2" xs = "2" className='mt-4'>
            <Col>
              <Button color = "plum" onClick={ actionSubmit } style = {{marginLeft:100}}>Add New Job</Button>
            </Col>
            <Col>
              <Button color = "plum" onClick={ actionRefresh } style = {{marginLeft:40}}>REFRESH All Jobs</Button>
            </Col>
          </Row>
        </Form>
