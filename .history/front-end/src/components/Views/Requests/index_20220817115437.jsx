    ...
    const addNewJobDiv = 
      <div className="add-job-div">
        ...
        <Form style={{marginTop: 20}}>
          ...
          <div style={{marginTop: 40 , marginLeft: 80}}>
          <Row lg = "2" md = "2" sm = "2" xs = "2" className='mt-4'>
            <Col>
              <Button className='Button_navigation' color = "secondary" onClick={ actionSubmit } style = {{marginLeft:100}}>Add New Job</Button>
            </Col>
            <Col>
              <Button className='Button_navigation' color = "secondary" onClick={ actionRefresh } style = {{marginLeft:40}}>REFRESH All Jobs</Button>
            </Col>
          </Row>
          </div>
        </Form>
