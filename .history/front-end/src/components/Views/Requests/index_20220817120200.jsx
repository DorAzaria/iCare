...
class ViewRequests extends React.Component {
  ...
  render () {
    ...
    const addNewJobDiv = 
      <div className="add-job-div">
          <div className="job-search" style={{}}>
            <div className="mt-1">
              <span className="job-title">Post a </span>
              <span className="job-title-A "> Request</span>
            </div>
        </div>
        <Form style={{marginTop: 20}}>
          ...
          <Row lg = "2" md = "2" sm = "2" xs = "2" className='mt-4'>
            <Col>
              <Button className='Button_navigation' color = "secondary" onClick={ actionSubmit } style = {{marginLeft:100, padding: 8}}>Add New Job</Button>
            </Col>
            <Col>
              <Button className='Button_navigation' color = "secondary" onClick={ actionRefresh } style = {{marginLeft:40 , padding: 8}}>REFRESH All Jobs</Button>
            </Col>
          </Row>
          </div>
        </Form>
    ...
    const renderA = () => {
      ...
      const body = (
        <div className="ViewRequestsParent container" style={{width: 1110, marginLeft: 20}}>
          {addNewJobDiv}
