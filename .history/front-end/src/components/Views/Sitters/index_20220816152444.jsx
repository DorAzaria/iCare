      ...
      const filterSitterDiv = 
        <div className = "filter-sitter-div">
          <div className = "filter-sitter-row">
            ...
            />
            <span style = {{marginLeft: '20px',color:'black', width:'120px', display:'inline-block'}}>Age Range: </span>
            <span> Min Age</span>
          ...
          <div className = "filter-sitter-row">
            ...
            />
            <span style = {{color:'black', width:'120px', display:'inline-block'}}>Gender: </span>
          ...
          <div className = "filter-sitter-row">
            ...
            />
            <span style = {{color:'black', width:'120px', display:'inline-block'}}>Skills: </span>
