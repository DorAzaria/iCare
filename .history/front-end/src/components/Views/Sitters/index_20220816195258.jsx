    ...
    const renderA = () => {
      ...
      const body = (
        <div className="ViewJobsBabysitter" >
          <div className="ViewJobsBabysitter_all container" style={{marginLeft: "150px"}}>
            
            {filterSitterDiv}
            <div className="ViewJobsBabysitter_titleAll" >
              <span className="Title_styleA" style={{ fontFamily: 'inherit', marginLeft: "160px" }}>{ titleAllSitters }</span>
            </div>
            <Row lg = "1" md = "1" sm = "1" xs = "1" style={{marginLeft: "150px"}}>
              { elementsSitter }
            </Row>
          </div>
        </div>
