  ...
  render () {
    ...
    const renderA = () => {
      ...
      const filterSitterDiv = 
        ...
        <div className = "filter-sitter-div" style={{ marginBottom: "60px", height: "320px",width:"100x"}}>
        ...
        <div style={{marginLeft:"200px"}}>
          ...
          <div style ={{marginLeft:440, marginTop: "10px"}}>
      ...
      const body = (
        <div className="ViewJobsBabysitter" >
          <div className="ViewJobsBabysitter_all container" style={{width: "1150px"}}>
            
            {filterSitterDiv}

            <div className="ViewJobsBabysitter_titleAll">
              <span className="Title_styleA" style={{ fontFamily: 'inherit' , marginLeft: "100px"}}>{ titleAllSitters }</span>
            </div>
