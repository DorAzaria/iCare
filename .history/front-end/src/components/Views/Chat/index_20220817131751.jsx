          ...
          <div className="ViewChat_container" style={{marginTop: 20}}>
            <Card>
              <CardHeader>
                ...
                <CardSubtitle tag="h6" style={{ paddingTop: 5 , marginTop: 15, color: 'gray'}}>
                  Job Title:
                </CardSubtitle>
                <CardTitle
                  tag="h3"
              ...
              <CardBody style={{ height: 550 }}>
                ...
                <div className="ViewChat_messageBox">
                  <InputGroup>
                    ...
                    <Button className="Button_navigation" color="secondary" style={{fontWeight: 700}} onClick={actionSendMessage}>
                      SEND
                    </Button>
                  </InputGroup>
                  <div className="ViewChat_messageSituation" style={{marginRight: 400}}>{situation}</div>
                </div>
