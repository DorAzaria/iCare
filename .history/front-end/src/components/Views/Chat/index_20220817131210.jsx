  ...
  render() {
    ...
    const renderCommon = () => {
      ...
      const makeMessageElement = (message, id) => {
        ...
        const msgProfileUrl = senderAvatar
          ? SERVER_PROFILE_URL + senderAvatar
          : "logo.png";
        return (
      ...
      const chatProfileUrl = recevierAvatar
        ? SERVER_PROFILE_URL + recevierAvatar
        : "logo.png";
      const body = (
        <div className="ViewChat">

          <div className="ViewChat_container" style={{marginTop: 20}}>
            <Card>
              <CardHeader>
                <img
                  src={chatProfileUrl}
                ...
                ></img>
                <div
                  style={{ float: "right", textAlign: "center", color: "gray" }}
                >
                ...
                <CardTitle
                  tag="h3"
                  style={{ color: "darkblue", marginBottom: 0 }}
                >
                  {title}
                </CardTitle>
              </CardHeader>
              <CardBody style={{ height: 550 }}>
                ...
                <div className="ViewChat_messageBox">
                  <InputGroup>
                    ...
                    <Button color="success" onClick={actionSendMessage}>
                      SEND
                    </Button>
                  </InputGroup>
            ...
            <Button className="Button_navigation" color="secondary" style={{padding: 8, marginLeft: 550, marginTop: 10, width:300}} onClick={actionRefresh}>
              REFRESH
            </Button>
