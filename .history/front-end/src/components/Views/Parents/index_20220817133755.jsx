      ...
      const filterParentDiv = 
        <div className = "filter-parent-div">
          ...
          <div style ={{marginLeft: 330}} >
            ...
            />
            <span style = {{color:'black', width:'250px', display:'inline-block'}}>Number of Children: </span>
          ...
          <div style ={{marginLeft:430, marginTop:20}}>
            <Button color = "secondary" className='Button_navigation' onClick={ actionRefresh }>Search Parents</Button>
          </div> 
        </div>
