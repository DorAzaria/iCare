...
class ViewJobDetail extends React.Component {
  ...
  render() {
    ...
    const makeCommentElement = (comment, id) => {
      ...
      return (
        <div key={key_comment}>
          ...
          <div className="leave-reply-div" style={{marginBottom: "20px"}}>
            <Button
              color="secondary"
            ...
            <textarea
              style={{ width: "100%", border: "1px solid plum" , marginBottom: "10px"}}
    ...
    const renderA = () => {
      ...
      const body = (
        <div className="ViewJobsDetail container" style={{width: "1150px"}}>
          {elementJob}
          ...
          <div className="mt-4">
            <div className="ViewJobsBabysitter_titleAll" style={{marginLeft: "110px"}}>
