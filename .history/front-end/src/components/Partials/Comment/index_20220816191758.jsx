...
class PartialComment extends React.Component {
  render() {
      ...
      return (
        <div key={reply_key} style={{ marginLeft: 10 }}>
          <img
            ...
            alt="user profile"
          ></img>
          <span style={{ color: "black", paddingLeft: 10, fontWeight: "500" }}> Reply</span>{" "}
          <span> left by {name_from}</span>
          <CardText style={{ marginLeft: 10, color: "black" }} tag="h6">
            {description}
          </CardText>
        </div>
      );
    ...
    return (
      <Col className="PartialComment_singleComment" style={{width: "930px", marginLeft: "120px" }}>
        <Card color="black" outline>
          ...
          <CardBody>
            ...
            <CardText style={{  color: "black" , borderBottom: "20px" }} tag="h5">
              {description}
            </CardText>
          </CardBody>
