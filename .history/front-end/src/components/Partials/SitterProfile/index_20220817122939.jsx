      ...
      <Col className="PartialSitter_singleSitterProfile" key={key} style={{width: 1100, marginLeft: 110}}>
        <Card color="success" outline>
          <CardHeader>
            ...
            <div style={{ float: "right", textAlign: "center", color: "gray" , float: 'left'}}>
              <CardTitle tag="h4">{username}</CardTitle>
              <CardSubtitle tag="h6">{city}</CardSubtitle>
            </div>

            <div style={{ color: "darkblue" , float: 'right' }}>
              Experience:
              <span style={{ color: "blue"  , float: 'right' }}> {exp_years} Years</span>
            </div>
            <div style={{ color: "darkblue"  , float: 'right' }}>
              Education:
              <span style={{ color: "blue" , float: 'right' }}> {education}</span>
            </div>
          </CardHeader>
