...
class PartialSitter extends React.Component {
  render() {
    ...
    return (
      <Col className="PartialSitter_singleSitter" key = {key} style={{width: "550px", marginLeft:"50px"}}>
        <Card style={{}}>
          <CardHeader>
            ...
            >
              <CardTitle style={{ margin:"10px",color: "#626567", fontSize: 35 , fontWeight: '250'}}>
                {username}
              </CardTitle>
          ...
          >
            ...
            <Link to={sitterProfileLink} className="Button_navigation" style={{padding: 7}}>
              Profile
            </Link>
            </div>
          </CardFooter>
