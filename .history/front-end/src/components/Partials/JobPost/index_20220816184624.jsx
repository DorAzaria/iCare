...
class PartialJobPost extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Col className="PartialSitter_singleSitter" key={key} style={{maxWidth: 1000, alignItems: 'center'}}>
        <Card outline style={{ borderRadius: "20px" , height: 230, alignItems: 'center' }}>
          ...
          <CardHeader>
              ...
              >
                ...
                props.page_type === "job" &&
                !applied ? (
                  <Link to={applyLink} className="Button_navigation" style={{ background: 'purple', width: "80px" }}>
                    APPLY
                  </Link>
                ) : (
                  ""
