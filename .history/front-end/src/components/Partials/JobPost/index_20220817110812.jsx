...
<img
    ...
    className=""
    alt="user profile"
    style={{ width: 45, height: 45, borderRadius: 25 , marginLeft: "10px"}}
  ></img>


  <div className="text-end" style={{ lineHeight: 1.3 , marginLeft: "20px"}}>
    <div>
      <span style={{ fontSize: 22, fontWeight: 500, float: "left" }}>
        {username}
      </span>
    </div>
    <div>
      <span style={{ fontSize: 14, fontWeight: 400 , float: "left" }}>
        {city} | {age} years old
      </span>
    </div>
  </div>
            ...
            <div className="d-flex justify-content-between">
              <div>
                ...
                <Link to={detailLink}>
                  <Icon.ChatLeftFill
                    className="m-1"
                    style={{ color: "#192478", fontSize: 22 }}
                  />
                </Link>
              </div>
              <span
