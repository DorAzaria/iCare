    ...
    return (
      <Col className="PartialSitter_singleSitter" key={key}>
        <Card outline style={{ borderRadius: "20px" }}>
          ...
          <CardBody style={{ height: 100 }}>
            <div>
              <div className="text-end" style={{float: "left"}}>
                ...
                <div>
                  <span style={{ fontSize: 14, color: "rgb(65 65 65)" , marginRight: 30 }}>
          ...
          >
            <div className="d-flex justify-content-between" style={{float: "left"}}>
            <span
                style={{
                  float: "left",
                  fontSize: "18px",
              ...
              <div className="d-flex justify-content-between" style={{float: "right", marginTop: "5px",}}>
              <span
                style={{
                  float: "right",
                  paddingRight: 10,
